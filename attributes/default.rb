...
default['redis']['build_dir'] = "/home/vagrant/build"

# install_prefix: Tells us the base directory where the package installs Redis
default['redis']['install_prefix'] = "/usr/local/redis-2.8.9"
...
default['redis']['executable'] = "#{default['redis']['install_prefix']}/bin/redis-server"
